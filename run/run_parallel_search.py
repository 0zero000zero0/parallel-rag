...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Parallel search runner")
    parser.add_argument(
        "--input_file",
        type=str,
        required=True,
...
def main() -> None:
    ...
    output_model_name = (
        args.navigator_agent_model or args.shared_model or args.model or "Qwen3-14B"
    )
    ...
    pipeline = ParallelSearch.from_args(args)
