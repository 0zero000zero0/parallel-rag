...
class SearchO1(PromptedGenerationBase):
    ...
    def _build_refine_agent_prompt(
        ...
        user_prompt = "\n\n".join(
            [
                ...
                self._format_external_context("Current Search Query", search_query),
    ...
    def run_batch(
        ...
        search_config = self._make_config(
        ...
        for iteration in range(1, max_iterations + 1):
            ...
            main_outputs = self._generate_text_batch(active_prompts, search_config)
            ...
            for idx, docs in enumerate(batch_docs):
                ...
                refine_meta.append(
                    (sample_i, search_query, selected_doc_ids, selected_docs)
                )
            ...
            for idx, refine_output in enumerate(refine_outputs):
                sample_i, search_query, selected_doc_ids, selected_docs = refine_meta[
                    idx
                ]
