...
python run/run_adaptive_parallel_o1.py \
  ...
  --navigator_agent_model_path ~/llm/models/Qwen3-32B \
  ...
  --global_refine_agent_model_path ~/llm/models/Qwen3-32B \
  ...
  --path_agent_model_path ~/llm/models/Qwen3-32B \
  --batch_size 10 \
